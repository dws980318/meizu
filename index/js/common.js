...
//手机hover
var phone = document.querySelectorAll('.nav-phone')[0];
...
up.onmouseleave = function() {
	timer = setTimeout(function() {
		$('#meizu-header-sub-download').removeClass('sub-nav-animation')
		$('#meizu-header-sub-download').removeClass	('sub-nav-show')
		$('.header-wrapper').removeClass('toggle')
		$('.nav li a').removeClass('toggle-a')
		$('.logo a').css('background-image', '')
		$('.header-item2').css('background-image', '')
